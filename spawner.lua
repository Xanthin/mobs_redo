...
minetest.register_node("mobs:spawner", {
	...
	on_construct = function(pos)
		...
		-- text entry formspec
		meta:set_string("formspec", "field[text;" .. S("Mob MinLight MaxLight Amount PlayerDist") .. ";${command}]")
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		and yof and yof > -10 and yof < 10 then
			...
			minetest.chat_send_player(name, S("> name min_light[0-14] max_light[0-14] max_mobs_in_area[0 to disable] distance[1-20] y_offset[-10 to 10]"))
		end
	end,
})
